...
These are DOM methods to access html element.  
getElementById returns a single unique element by Id, getElementsByClassName returns a collection of html elements by Class name, querySelector returns the first matching element using CSS selector and querySelectorAll returns a NodeList of html element using CSS selector.
